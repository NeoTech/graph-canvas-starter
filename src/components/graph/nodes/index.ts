...
class CircleVisualizerNode extends LGraphNode {
  ...
  constructor() {
    ...
    this.addProperty("x", 400);
    this.addProperty("y", 200);
    this.addProperty("radius", 50);
    this.addProperty("zIndex", 0);
    this.addProperty("fill", "#22d3ee");
    this.addProperty("stroke", "#0891b2");
    this.size = [200, 140];
    this.color = "#0e7490";
    this.bgcolor = "#164e63";
  }
...
class RectangleVisualizerNode extends LGraphNode {
  ...
  constructor() {
    ...
    this.addInput("Z-Index", "number");
    this.addOutput("Shape", "shape");
    this.addProperty("x", 350);
    this.addProperty("y", 150);
    this.addProperty("width", 100);
    this.addProperty("height", 100);
    this.addProperty("zIndex", 0);
    this.addProperty("fill", "#a855f7");
    this.addProperty("stroke", "#7c3aed");
    this.size = [200, 160];
    this.color = "#6d28d9";
    this.bgcolor = "#4c1d95";
  }
...
class SpiralVisualizerNode extends LGraphNode {
  ...
  constructor() {
    ...
    this.addInput("Z-Index", "number");
    this.addOutput("Shape", "shape");
    this.addProperty("centerX", 400);
    this.addProperty("centerY", 200);
    this.addProperty("turns", 5);
    this.addProperty("spacing", 10);
    this.addProperty("zIndex", 0);
    this.addProperty("stroke", "#22d3ee");
    this.size = [200, 130];
    this.color = "#0e7490";
    this.bgcolor = "#164e63";
  }
...
class WaveVisualizerNode extends LGraphNode {
  ...
  constructor() {
    ...
    this.addInput("Z-Index", "number");
    this.addOutput("Shape", "shape");
    this.addProperty("amplitude", 50);
    this.addProperty("frequency", 2);
    this.addProperty("phase", 0);
    this.addProperty("zIndex", 0);
    this.addProperty("stroke", "#a855f7");
    this.size = [200, 150];
    this.color = "#7c3aed";
    this.bgcolor = "#5b21b6";
  }
...
class PolygonVisualizerNode extends LGraphNode {
  ...
  constructor() {
    ...
    this.addProperty("centerX", 400);
    this.addProperty("centerY", 200);
    this.addProperty("sides", 6);
    this.addProperty("radius", 80);
    this.addProperty("zIndex", 0);
    this.addProperty("fill", "#34d399");
    this.addProperty("stroke", "#059669");
    this.size = [200, 130];
    this.color = "#047857";
    this.bgcolor = "#064e3b";
  }
...
class PolarArrayNode extends LGraphNode {
  ...
  constructor() {
    ...
    this.addProperty("centerX", 400);
    this.addProperty("centerY", 300);
    this.addProperty("count", 8);
    this.addProperty("radius", 120);
    this.addProperty("rotation", 0);
    this.addProperty("treatAsGroup", true);
...
class GridArrayNode extends LGraphNode {
  ...
  constructor() {
    ...
    this.addOutput("Shapes", "shape_array");
    this.addProperty("startX", 50);
    this.addProperty("startY", 50);
    this.addProperty("rows", 3);
    this.addProperty("columns", 3);
    this.addProperty("spacingX", 50);
    this.addProperty("spacingY", 50);
    this.addProperty("treatAsGroup", true);
    this.addWidget("toggle", "Treat As Group", this.properties.treatAsGroup, (v: any) => {
      this.properties.treatAsGroup = v;
    });
...
class CircularArrayNode extends LGraphNode {
  ...
  constructor() {
    ...
    this.addProperty("centerX", 400);
    this.addProperty("centerY", 300);
    this.addProperty("count", 12);
    this.addProperty("radius", 100);
    this.addProperty("startAngle", 0);
    this.addProperty("endAngle", 360);
    this.addProperty("treatAsGroup", true);
...
class ComposeShapesNode extends LGraphNode {
  ...
  constructor() {
    ...
    this.addProperty("aX", 0);
    this.addProperty("aY", 0);
    this.addProperty("bX", 100);
    this.addProperty("bY", 0);
    this.addProperty("composeX", 400);
    this.addProperty("composeY", 200);
    this.size = [220, 200];
    this.color = "#d946ef";
    this.bgcolor = "#a21caf";
  }
