...
export class GridArrayNode extends LGraphNode {
  ...
  constructor() {
    ...
    this.addProperty("startX", 0, "number");
    this.addProperty("startY", 0, "number");
    ...
    this.addWidget("number", "Start X", 0, (v: number) => {
      this.properties.startX = v;
    });
    this.addWidget("number", "Start Y", 0, (v: number) => {
      this.properties.startY = v;
    });
    this.addWidget("number", "Rows", 3, (v: number) => {
      this.properties.rows = v;
    });
    this.addWidget("number", "Columns", 3, (v: number) => {
      this.properties.columns = v;
    });
    this.addWidget("number", "Spacing X", 50, (v: number) => {
      this.properties.spacingX = v;
    });
    this.addWidget("number", "Spacing Y", 50, (v: number) => {
      this.properties.spacingY = v;
    });
  ...
  onExecute() {
    ...
    const startX = startXInput !== undefined && startXInput !== null ? startXInput : this.properties.startX;
    const startY = startYInput !== undefined && startYInput !== null ? startYInput : this.properties.startY;
